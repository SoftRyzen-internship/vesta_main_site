...
export const ServiceCard: FC<IServiceCardProps> = ({
  ...
  return (
    <div
      className={`h-[635px] w-[360px] bg-bgText px-4 py-10 md:h-full md:w-full md:px-[94px] md:py-[74px] xl:flex xl:w-[1216px] xl:justify-between xl:px-[70px] xl:py-20 ${s.card}`}
    >
